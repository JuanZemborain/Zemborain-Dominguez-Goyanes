    ...
    render(){
        return(
            <React.Fragment>
                ...
                {this.state.loaderPopularMovies ? <p>Cargando...</p> : <ListaCard data={this.state.popularMovies.filter((peli, idx)  => idx < 4)} tipo="movie" />}
                ...
                {this.state.loaderNowMovies ? <p>Cargando...</p> : <ListaCard data={this.state.nowMovies.filter((peli, idx)  => idx < 4)} tipo="movie" />}
                ...
                {this.state.loaderPopularMovies ? <p>Cargando...</p> : <ListaCard data={this.state.seriesTopRating.filter((peli, idx)  => idx < 4)} tipo="tv" />}
                ...
                {this.state.loaderNowMovies ? <p>Cargando...</p> : <ListaCard data={this.state.seriesAiring.filter((peli, idx)  => idx < 4)} tipo="tv" />}
